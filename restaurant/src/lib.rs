...
// // use crate::front_of_house::hosting::add_to_waitlist; // you can also just use methods
...
// // // bring item into scope (use) but also make it available for others
// // // to bring to their scope (pub)
...
// //     pub use crate::engine::systems::combat::weapons::Broadsword;
// // }

mod front_of_house; // declaration, src/front_of_house.rs
